...
const pointLight = new THREE.PointLight(0xff9000, 0.5, 10, 0.5);
pointLight.position.set(1, -0.5, 1);

scene.add(pointLight);
// only works with MeshStandardMaterial and MeshPhysicalMaterial
const rectAreaLight = new THREE.RectAreaLight(0x4e00ff, 2, 1, 1);
rectAreaLight.position.set(-2.375, -0.039, -2.621);
rectAreaLight.rotation.set(-3.12141482953494, -0.777, -0.408);
gui
...
gui
  ...
  .max(5)
  .step(0.001)
  .name("reactArea rotate x");
gui
  .add(rectAreaLight.rotation, "y")
  .min(-5)
  .max(5)
  .step(0.001)
  .name("reactArea rotate y");
gui
  .add(rectAreaLight.rotation, "z")
  .min(-5)
  .max(5)
  .step(0.001)
  .name("reactArea rotate z");
